...
The **Tree Table** Widget displays hierarchical data in rows and columns. It is a combination of the [Table](../Widgets.DataDisplay.Table/index.md) and [Tree](../Widgets.DataDisplay.Tree/index.md).
...
- [Basic](../Widgets.DataDisplay.TreeTable.Basic#basic/index.md)
- [Async](../Widgets.DataDisplay.TreeTable.Basic#async/index.md)
- [Accessibility](../Widgets.DataDisplay.TreeTable.Basic#accessibility/index.md)
- [Content Type Example](../Widgets.DataDisplay.TreeTable.Basic#contentTypeExample/index.md)